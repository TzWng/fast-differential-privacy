...
#       --dimension 32 \
#       --optimizer SGD \
#       --log_path "/content/drive/MyDrive/DP_muP/logs/MLP_SGD_depth5_diffwidth_approx_ratio_dinfix_sp.txt"
#   done
# done


LRS=(-4 -4.5 -5 -5.25 -5.5 -5.75 -6 -6.5 -7 -7.5 -8) # SGD
# 288 512 1152 2048 4608 8192
for wid in 8192; do 
  for lr in "${LRS[@]}"; do
    echo "Running width=$wid, lr=$lr, dim=32"
    $PYTHON -m scripts.MLP_approx \
      ...
      --dimension 32 \
      --optimizer SGD \
      --log_path "/content/drive/MyDrive/DP_muP/logs/MLP_SGD_depth5_diffwidth_approx_ratio_dinfix_2.txt"
  done
done
...
#       --dimension 32 \
#       --optimizer muon \
#       --log_path "/content/drive/MyDrive/DP_muP/logs/MLP_muon_depth5_diffwidth_nonDP_all_new.txt"
#   done
# done
...
# LRS=(-9.5 -9 -8.5 -8 -7.75 -7.5 -7.25 -7 -6.75 -6.5) # SGD
...
#       --dimension 32 \
#       --optimizer SGD \
#       --log_path "/content/drive/MyDrive/DP_muP/logs/MLP_Muon_depth5_diffwidth_approx_ratio_double_sgd.txt"
#   done
# done
