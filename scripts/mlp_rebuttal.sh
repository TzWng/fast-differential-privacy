...
#       --dimension 32 \
#       --optimizer SGD \
#       --log_path "/content/drive/MyDrive/DP_muP/logs_rebuttal/MLP_SGD_depth5_s2l_epsilon2_dinfix_dpmup_temp.txt"
#   done
# done
...
for wid in 256 512 1024 2048 4096 8192; do
  for lr in "${LRS[@]}"; do 
    ...
    $PYTHON -m scripts.dpmup_sgd \
      ...
      --dimension 32 \
      --optimizer Adam \
      --log_path "/content/drive/MyDrive/DP_muP/logs_rebuttal/MLP_Adam_depth5_s2l_epsilon2_dinfix_dpmup_seed3.txt"
  done
done
