...
# LRS=(-5 -4.5 -4 -3.5 -3 -2.5 -2 -1.5) # SGD
# # 256 512 1024 2048 4096 8192
# for wid in 256 512 1024 2048 4096 8192; do
#   for lr in "${LRS[@]}"; do 
#     echo "Running width=$wid, lr=$lr, dim=32"
...
#       --dimension 32 \
#       --optimizer SGD \
#       --log_path "/content/drive/MyDrive/DP_muP/logs_rebuttal/MLP_SGD_depth5_s2l_epsilon2_dinfix_dpsp_seed2.txt"
#   done
# done
...
for wid in 256 512 1024 2048 4096 8192; do
  for lr in "${LRS[@]}"; do 
    ...
    $PYTHON -m scripts.MLP_sp \
      ...
      --dimension 32 \
      --optimizer Adam \
      --log_path "/content/drive/MyDrive/DP_muP/logs_rebuttal/MLP_Adam_depth5_s2l_epsilon2_dinfix_dpsp_seed2.txt"
  done
done
