...
from scripts.get_params_gpt2 import get_shapes, _get_noise4target, _get_lr4target, _get_clip4target, _get_lr4target_adam
...
while True:
    ...
    # 2. 计算衰减比例 (Factor)
    lr_factor = lr / learning_rate

    # 3. 将衰减比例应用到每个参数组特有的 base_mup_lr 上
